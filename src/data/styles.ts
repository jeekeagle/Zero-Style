// 52 种设计风格数据源
// 每个风格含: id, slug, name(英), nameZh(中), category, year, description,
//   characteristics[], colors[], typography[], useCases[], examples[], visual
...
export type Style = {
  ...
  useCases: string[]
  examples: string[]
  visual: 'minimal' | 'memphis' | 'neumorph' | 'glass' | 'cyber' | 'vapor' |
          'pixel' | 'swiss' | 'bauhaus' | 'artdeco' | 'ink' | 'zen' |
          'ukiyo' | 'arabic' | 'mehndi' | 'tang' | 'bluewhite' | 'morandi' |
          'macaron' | 'earth' | 'neon' | 'mono' | 'film' | 'pastel' |
          'serif' | 'sans' | 'hand' | 'pixelfont' | 'kai' | 'mono-font' |
          'y2k' | 'psychedelic' | 'retro80' | 'grunge' | 'disco' | 'mtv' |
          'paper' | 'frost' | 'metal' | 'wood' | 'water' | 'fabric' |
          'tech' | 'editorial' | 'nordic' | 'dark' | 'brutal' | 'magazine' |
          'flat' | 'material' | '3d' | 'gradient'
}

export const CATEGORIES = [
  { id: 'visual',    name: '视觉表现',   nameEn: 'Visual Styles',  desc: '从极简到繁复的视觉语言' },
  { id: 'eastern',   name: '东方古典',   nameEn: 'Eastern Classical', desc: '东方传统美学与现代设计的融合' },
  { id: 'color',     name: '配色方案',   nameEn: 'Color Schemes',  desc: '色彩的情感与象征' },
  { id: 'typography', name: '字体排版',  nameEn: 'Typography',     desc: '字体的性格与节奏' },
  { id: 'era',       name: '时代年代',   nameEn: 'Era',            desc: '时代精神在视觉上的回响' },
  { id: 'material',  name: '材质纹理',   nameEn: 'Material',       desc: '触觉延伸到视觉' },
  { id: 'modern',    name: '现代趋势',   nameEn: 'Modern Trends',  desc: '当下与未来的设计语言' },
]

export const STYLES: Style[] = [
  // ===== 视觉表现 (10) =====
  {
    id: 'minimalism', slug: 'minimalism', name: 'Minimalism', nameZh: '极简主义',
    category: 'visual', year: '1960s',
    ...
    colors: [{ name: '纯白', hex: '#ffffff' }, { name: '纯黑', hex: '#000000' }, { name: '灰', hex: '#f5f5f5' }],
  ...
  {
    id: 'memphis', slug: 'memphis', name: 'Memphis', nameZh: '孟菲斯',
    category: 'visual', year: '1981',
    tagline: '打破规则的派对。',
    ...
    colors: [{ name: '粉', hex: '#ff6b9d' }, { name: '黄', hex: '#ffd93d' }, { name: '蓝', hex: '#4d96ff' }, { name: '黑', hex: '#000000' }],
  ...
  {
    id: 'neumorphism', slug: 'neumorphism', name: 'Neumorphism', nameZh: '新拟物',
    category: 'visual', year: '2020',
    tagline: '柔软的浮雕。',
    ...
    colors: [{ name: '米色背景', hex: '#e0e5ec' }, { name: '亮阴影', hex: '#ffffff' }, { name: '暗阴影', hex: '#a3b1c6' }],
  ...
  {
    id: 'glassmorphism', slug: 'glassmorphism', name: 'Glassmorphism', nameZh: '玻璃拟态',
    category: 'visual', year: '2020',
    tagline: '透明与模糊。',
    ...
    colors: [{ name: '白半透明', hex: 'rgba(255,255,255,0.2)' }, { name: '紫', hex: '#7c3aed' }, { name: '粉', hex: '#ec4899' }],
  ...
  {
    id: 'cyberpunk', slug: 'cyberpunk', name: 'Cyberpunk', nameZh: '赛博朋克',
    category: 'visual', year: '1980s',
    tagline: '高科技,低生活。',
    ...
    colors: [{ name: '霓虹粉', hex: '#ff006e' }, { name: '霓虹青', hex: '#00f5ff' }, { name: '黑', hex: '#0a0a0a' }],
  ...
  {
    id: 'vaporwave', slug: 'vaporwave', name: 'Vaporwave', nameZh: '蒸汽波',
    category: 'visual', year: '2010',
    tagline: '消逝的消费主义。',
    ...
    colors: [{ name: '紫', hex: '#a855f7' }, { name: '粉', hex: '#ec4899' }, { name: '青', hex: '#06b6d4' }],
  ...
  {
    id: 'pixel-retro', slug: 'pixel-retro', name: 'Pixel Retro', nameZh: '像素复古',
    category: 'visual', year: '1980s',
    tagline: '低分辨率,高表达。',
    ...
    colors: [{ name: 'NES 红', hex: '#d62828' }, { name: 'NES 蓝', hex: '#003049' }, { name: 'NES 黄', hex: '#fcbf49' }],
  ...
  {
    id: 'swiss-design', slug: 'swiss-design', name: 'Swiss Design', nameZh: '瑞士国际',
    category: 'visual', year: '1950s',
    tagline: '理性的网格。',
    ...
    colors: [{ name: '黑', hex: '#000000' }, { name: '白', hex: '#ffffff' }, { name: '瑞士红', hex: '#e30613' }],
  ...
  {
    id: 'bauhaus', slug: 'bauhaus', name: 'Bauhaus', nameZh: '包豪斯',
    category: 'visual', year: '1919',
    tagline: '形式追随功能。',
    ...
    colors: [{ name: '红', hex: '#e63946' }, { name: '蓝', hex: '#1d3557' }, { name: '黄', hex: '#f1c40f' }],
  ...
  {
    id: 'art-deco', slug: 'art-deco', name: 'Art Deco', nameZh: '装饰艺术',
    category: 'visual', year: '1920s',
    tagline: '奢华的几何。',
    description: '1920-30 年代法国兴起的装饰艺术风格,以奢华、对称、几何图案(扇形/锯齿/太阳放射)为标志,代表爵士时代的优雅。',
    characteristics: ['对称构图', '几何图案(扇形/锯齿)', '奢华金属感', '粗体衬线', '阶梯式'],
    colors: [{ name: '金', hex: '#d4af37' }, { name: '深绿', hex: '#0f3a2e' }, { name: '黑', hex: '#1a1a1a' }],
    typography: '几何衬线(Poiret One,Limelight)',
    useCases: ['高端品牌', '酒店', '奢侈品包装'],
    examples: ['克莱斯勒大厦', '大 Gatsby 电影'],
    visual: 'artdeco',
  },

  // ===== 东方古典 (7) =====
  {
    id: 'chinese-ink', slug: 'chinese-ink', name: 'Chinese Ink Wash', nameZh: '中国水墨',
    category: 'eastern', year: '唐宋',
    tagline: '墨分五色。',
    description: '起源于唐宋的中国水墨画,以墨色浓淡(焦/浓/重/淡/清)表现山水意境,"留白"为构图核心,讲究气韵生动。',
    characteristics: ['浓淡墨色', '大量留白', '山水花鸟主题', '印章与题款', '气韵生动'],
    colors: [{ name: '宣纸白', hex: '#f5e8c7' }, { name: '焦墨', hex: '#1a1a1a' }, { name: '朱砂', hex: '#c0392b' }],
    typography: '毛笔楷书/行书',
  ...
  {
    id: 'japanese-zen', slug: 'japanese-zen', name: 'Japanese Zen', nameZh: '日式禅意',
    category: 'eastern', year: '14世纪',
    tagline: '侘寂 wabi-sabi。',
    description: '日本禅宗美学,以"侘寂"(wabi-sabi)为核心理念,接受不完美、无常、不对称,体现极简、自然、安静的东方哲学。',
    characteristics: ['极度留白', '不对称(不对称美)', '自然材质', '单一红点/印章', '静谧氛围'],
    colors: [{ name: '米白', hex: '#f5f0e8' }, { name: '墨', hex: '#2c2c2c' }, { name: '朱', hex: '#c43e3e' }],
    typography: '明朝体(细衬线)',
  ...
  {
    id: 'ukiyo-e', slug: 'ukiyo-e', name: 'Ukiyo-e', nameZh: '浮世绘',
    category: 'eastern', year: '江户',
    tagline: '浮世的瞬间。',
    description: '江户时代(17-19 世纪)日本木刻版画,以鲜艳色彩、明确轮廓、平涂色块描绘歌舞伎、艺伎、风景,是日本最具国际影响力的艺术形式。',
    characteristics: ['平涂色块', '明确轮廓', '鲜艳对比', '风景/人物', '装饰性边框'],
    colors: [{ name: '群青', hex: '#1f3a93' }, { name: '朱', hex: '#c0392b' }, { name: '金', hex: '#d4af37' }],
    typography: '竖排毛笔字',
  ...
  {
    id: 'arabic-geometric', slug: 'arabic-geometric', name: 'Arabic Geometric', nameZh: '阿拉伯几何',
    category: 'eastern', year: '中世纪',
    tagline: '无限的几何。',
    description: '伊斯兰艺术因避免偶像崇拜,发展出举世无双的几何图案(Star Pattern)与阿拉伯书法,体现了数学之美与对无限的崇敬。',
    characteristics: ['八角星/十二角星', '几何镶嵌', '无始无终', '对称图案', '阿拉伯书法'],
    colors: [{ name: '蓝', hex: '#1e3a8a' }, { name: '金', hex: '#d4af37' }, { name: '白', hex: '#ffffff' }],
  ...
  {
    id: 'indian-mehndi', slug: 'indian-mehndi', name: 'Indian Mehndi', nameZh: '印度曼海蒂',
    category: 'eastern', year: '古代',
    tagline: '手绘的祝福。',
    description: '印度传统身体彩绘艺术,以指甲花(海娜)绘制精细的藤蔓、花卉、几何图案,用于婚礼、宗教节日,象征好运与祝福。',
    characteristics: ['精细藤蔓图案', '花卉/几何', '手绘温度', '对称美感', '红褐色'],
    colors: [{ name: '海娜棕', hex: '#8b4513' }, { name: '朱砂', hex: '#c0392b' }, { name: '金', hex: '#d4af37' }],
  ...
  {
    id: 'tang-pattern', slug: 'tang-pattern', name: 'Tang Pattern', nameZh: '唐卷草纹',
    category: 'eastern', year: '唐代',
    tagline: '连绵的生机。',
    description: '唐代盛行的卷草纹(亦称唐草),以 S 形连续曲线串联花朵叶片,源自希腊传入并中国化,象征生生不息。',
    characteristics: ['S 形连续曲线', '花卉叶片串联', '对称循环', '金色线条', '繁复精致'],
    colors: [{ name: '金', hex: '#d4af37' }, { name: '朱', hex: '#a82d2d' }, { name: '墨', hex: '#1a1a1a' }],
    typography: '楷书',
  ...
  {
    id: 'blue-white-porcelain', slug: 'blue-white-porcelain', name: 'Blue-White Porcelain', nameZh: '青花瓷',
    category: 'eastern', year: '元代',
    tagline: '青白之间。',
    description: '元代成熟的青花瓷,以钴蓝在白胎上绘画,经高温烧制形成白底蓝花的经典样式,后经丝绸之路远播欧洲,影响深远。',
    characteristics: ['白底蓝花', '钴蓝单色', '花卉山水主题', '釉下彩', '对称构图'],
    colors: [{ name: '钴蓝', hex: '#1e3a8a' }, { name: '白胎', hex: '#f5f5f0' }, { name: '米色', hex: '#e8e0d0' }],
    typography: '楷书',
  ...
  // ===== 配色方案 (7) =====
  {
    id: 'morandi', slug: 'morandi', name: 'Morandi', nameZh: '莫兰迪',
    category: 'color', year: '现代',
    tagline: '灰调的温柔。',
    description: '源自意大利画家 Giorgio Morandi 的静物画色调,以低饱和度的灰调色彩(灰粉/灰蓝/灰绿)营造温柔、宁静、有距离感的氛围。',
    characteristics: ['低饱和度', '灰色调', '相近色系', '温柔安静', '高级感'],
    colors: [{ name: '灰粉', hex: '#d4b5b0' }, { name: '灰蓝', hex: '#a8b8c8' }, { name: '灰绿', hex: '#b5c4b1' }],
  ...
  {
    id: 'macaron', slug: 'macaron', name: 'Macaron', nameZh: '马卡龙',
    category: 'color', year: '现代',
    tagline: '甜品的色谱。',
    description: '源于法国马卡龙甜品的高明度低饱和色彩,以柔和的粉、薄荷绿、薰衣草紫等组合,营造甜美、少女、清新的视觉氛围。',
    characteristics: ['高明度', '低饱和度', '粉嫩色系', '甜美可爱', '轻柔感'],
    colors: [{ name: '樱花粉', hex: '#ffd1dc' }, { name: '薄荷', hex: '#b5e5cf' }, { name: '薰衣草', hex: '#e0b8e0' }],
    typography: '圆润无衬线或手写',
  ...
  {
    id: 'earth-tone', slug: 'earth-tone', name: 'Earth Tone', nameZh: '大地色',
    category: 'color', year: '原始',
    tagline: '泥土的颜色。',
    description: '源自自然大地色彩(棕、米、陶土、橄榄绿),传达温暖、可靠、自然、原始的感受,是户外/家居/手作品牌的常用配色。',
    colors: [{ name: '焦糖棕', hex: '#a67c52' }, { name: '陶土', hex: '#c87856' }, { name: '橄榄', hex: '#7a8450' }, { name: '米色', hex: '#e8dcc0' }],
    typography: '衬线/手写皆宜',
  ...
  {
    id: 'neon', slug: 'neon', name: 'Neon', nameZh: '霓虹荧光',
    category: 'color', year: '1980s',
    tagline: '电光的色彩。',
    description: '高饱和度的荧光色(电光粉/霓虹绿/电子紫),在暗色背景上发光,源自 80 年代夜店与赛博朋克美学,极富活力与未来感。',
    colors: [{ name: '电光粉', hex: '#ff10f0' }, { name: '霓虹绿', hex: '#39ff14' }, { name: '电子紫', hex: '#bc13fe' }],
    typography: '科技/未来感字体',
  ...
  {
    id: 'monochrome', slug: 'monochrome', name: 'Monochrome', nameZh: '单色调',
    category: 'color', year: '古典',
    tagline: '一色的深度。',
    description: '使用同一色相的不同明度/饱和度构成画面,通过层次而非色彩对比制造视觉张力,营造统一、高级、专业的氛围。',
    characteristics: ['单一色相', '明度层次', '高级感', '统一性强', '克制'],
    colors: [{ name: '蓝深', hex: '#0a1628' }, { name: '蓝中', hex: '#1e3a8a' }, { name: '蓝浅', hex: '#bfdbfe' }],
  ...
  {
    id: 'film-retro', slug: 'film-retro', name: 'Film Retro', nameZh: '复古胶片',
    category: 'color', year: '1970s',
    tagline: '胶片的颗粒。',
    description: '模仿 70 年代柯达/富士胶片的色调,以暖黄/橙红阴影、颗粒感、暗角为标志,营造怀旧、温柔、有故事感的氛围。',
    characteristics: ['暖色调', '颗粒感', '暗角', '轻微过曝', '复古滤镜'],
    colors: [{ name: '暖橙', hex: '#e89b6c' }, { name: '胶片黄', hex: '#f4e4c1' }, { name: '复古蓝', hex: '#5b8fa8' }],
    typography: '手写/衬线',
  ...
  {
    id: 'pastel', slug: 'pastel', name: 'Pastel', nameZh: '粉彩',
    category: 'color', year: '1950s',
    tagline: '柔色的梦境。',
    description: '粉彩色调源自 50 年代美式家居,以高明度、低饱和度的柔和色彩(粉、薄荷、淡蓝)为主,营造轻盈、温柔、怀旧的氛围。',
    colors: [{ name: '粉', hex: '#ffb3ba' }, { name: '薄荷', hex: '#bae1ff' }, { name: '淡黄', hex: '#ffffba' }, { name: '淡紫', hex: '#e0bbff' }],
    typography: '圆润手写',
  ...
  // ===== 字体排版 (6) =====
  {
    id: 'serif', slug: 'serif-classic', name: 'Serif Classic', nameZh: '衬线经典',
    category: 'typography', year: '15世纪',
    tagline: '笔尖的优雅。',
    description: '衬线体(Serif)在字母笔画末端有装饰性衬线,源自 15 世纪古腾堡印刷,代表传统、权威、可读性,常见于书籍、报刊、高端品牌。',
    characteristics: ['衬线装饰', '传统感', '高可读性', '权威性', '多用于长文'],
    colors: [{ name: '黑', hex: '#1a1a1a' }, { name: '米白', hex: '#f5f0e8' }],
  ...
  {
    id: 'sans-modern', slug: 'sans-modern', name: 'Sans Modern', nameZh: '无衬线现代',
    category: 'typography', year: '20世纪',
    tagline: '干净的呼吸。',
    description: '无衬线体(Sans-Serif)去除笔画末端的装饰,以几何或人文风格的简洁造型为标志,代表现代、清晰、中性,广泛应用在屏幕 UI。',
    characteristics: ['无衬线', '几何/人文', '屏幕友好', '现代感', '中性'],
    colors: [{ name: '任意', hex: '#000000' }],
  ...
  {
    id: 'hand-written', slug: 'hand-written', name: 'Hand Written', nameZh: '手写体',
    category: 'typography', year: '永恒',
    tagline: '手的温度。',
    description: '手写体强调"人手"的痕迹,从优雅的铜版手写体(Copperplate)到随意的马克笔手写,传达个性、温度、亲密感。',
    characteristics: ['手绘痕迹', '个性化', '温度感', '不规则', '亲密'],
    colors: [{ name: '墨', hex: '#1a1a1a' }, { name: '暖白', hex: '#f5e8c7' }],
  ...
  {
    id: 'pixel-font', slug: 'pixel-font', name: 'Pixel Font', nameZh: '像素字',
    category: 'typography', year: '1980s',
    tagline: '点阵的拼图。',
    description: '像素字体由方格像素拼出字母,源自 8-bit 时代游戏机,在低分辨率下保持可读,代表复古、游戏、极客文化。',
    characteristics: ['像素方格', '有限像素', '复古游戏', '黑色硬边', '等宽'],
    colors: [{ name: '绿', hex: '#39ff14' }, { name: '黑', hex: '#000000' }],
  ...
  {
    id: 'chinese-kai', slug: 'chinese-kai', name: 'Chinese Kai', nameZh: '汉字楷书',
    category: 'typography', year: '汉魏',
    tagline: '方正之美。',
    description: '楷书起源于汉魏,以端正工整、笔画清晰为特点,是中文印刷与书法的基础字体,代表庄重、文化、可读性。',
    characteristics: ['端正工整', '笔画清晰', '印刷友好', '庄重感', '传统美'],
    colors: [{ name: '墨', hex: '#1a1a1a' }, { name: '宣纸', hex: '#f5e8c7' }],
  ...
  {
    id: 'monospace', slug: 'monospace', name: 'Monospace', nameZh: '等宽字',
    category: 'typography', year: '1960s',
    tagline: '代码的节奏。',
    description: '等宽字体(Monospace)每个字符宽度相同,源自打字机时代,在代码编辑、终端、数据表格中保持对齐,代表技术、精确。',
    characteristics: ['等宽字符', '技术感', '对齐友好', '终端友好', '极客'],
    colors: [{ name: '黑', hex: '#1a1a1a' }, { name: '背景', hex: '#f5f5f5' }],
  ...
  // ===== 时代年代 (6) =====
  {
    id: 'y2k', slug: 'y2k', name: 'Y2K', nameZh: 'Y2K 千禧',
    category: 'era', year: '1990s-2000s',
    tagline: '千年虫的乐观。',
    description: 'Y2K(Year 2000)是 90 年代末-00 年代初的设计风格,以铬金属感、透明塑料、泡泡字、鲜艳渐变体现千禧年的乐观未来主义。',
    characteristics: ['铬金属感', '透明塑料', '泡泡字', '蓝紫渐变', '未来乐观'],
    colors: [{ name: '铬银', hex: '#c0c0c0' }, { name: '宝蓝', hex: '#0066ff' }, { name: '紫', hex: '#8a2be2' }, { name: '粉', hex: '#ff69b4' }],
  ...
  {
    id: 'psychedelic-60s', slug: 'psychedelic-60s', name: 'Psychedelic 60s', nameZh: '60年代迷幻',
    category: 'era', year: '1960s',
    tagline: '迷幻的迷醉。',
    description: '1960 年代嬉皮士文化与 LSD 影响下的视觉风格,以漩涡图案、霓虹色、扭曲字体、自由反叛为标志。',
    characteristics: ['漩涡图案', '霓虹撞色', '扭曲字体', '自由反叛', '迷幻'],
    colors: [{ name: '橙', hex: '#ff6600' }, { name: '紫', hex: '#9933ff' }, { name: '黄', hex: '#ffff00' }],
  ...
  {
    id: 'retro-80s', slug: 'retro-80s', name: 'Retro 80s', nameZh: '80年代复古',
    category: 'era', year: '1980s',
    tagline: '霓虹与磁带。',
    description: '1980 年代是 MTV、合成器、Walkman 的时代,设计以霓虹渐变、网格透视、磁带/录像带元素、合成波字体为标志。',
    characteristics: ['霓虹渐变', '网格透视', '合成波字体', '磁带元素', '电子感'],
    colors: [{ name: '霓虹粉', hex: '#ff10f0' }, { name: '紫蓝', hex: '#6633ff' }, { name: '青', hex: '#00ffff' }],
    typography: '未来粗体无衬线',
  ...
  {
    id: 'grunge-90s', slug: 'grunge-90s', name: 'Grunge 90s', nameZh: '90年代垃圾摇滚',
    category: 'era', year: '1990s',
    tagline: '破败的反叛。',
    description: '90 年代垃圾摇滚(Grunge)与 X 世代反主流文化下的设计,以撕裂纸张、粗糙纹理、不规则排版、DIY 美学为标志。',
    characteristics: ['撕裂纸张', '粗糙纹理', '不规则排版', 'DIY 感', '反主流'],
    colors: [{ name: '灰', hex: '#6b7280' }, { name: '暗红', hex: '#8b0000' }, { name: '黑', hex: '#1a1a1a' }],
    typography: '粗黑无衬线,歪斜',
  ...
  {
    id: 'disco-70s', slug: 'disco-70s', name: 'Disco 70s', nameZh: '70年代迪斯科',
    category: 'era', year: '1970s',
    tagline: '舞池的反射。',
    description: '1970 年代迪斯科文化的视觉呈现,以镜面球、霓虹条、棕橙暖色、曲线字体为代表,传递享乐、派对、自由的氛围。',
    characteristics: ['镜面球', '霓虹条', '棕橙暖色', '曲线字体', '享乐主义'],
    colors: [{ name: '焦糖', hex: '#c87856' }, { name: '金', hex: '#d4af37' }, { name: '棕', hex: '#5c3317' }],
    typography: '曲线感的衬线',
  ...
  {
    id: 'mtv-90s', slug: 'mtv-90s', name: 'MTV 90s', nameZh: '90年代MTV',
    category: 'era', year: '1990s',
    tagline: '频道的视觉。',
    description: '1990 年代 MTV 音乐频道的美学,以手绘涂鸦、撞色、碎片拼贴、卡通字体为代表,是 X 世代青年文化的视觉代表。',
    characteristics: ['手绘涂鸦', '撞色', '碎片拼贴', '卡通字体', '青年文化'],
    colors: [{ name: '柠檬黄', hex: '#ffff00' }, { name: '天蓝', hex: '#00bfff' }, { name: '品红', hex: '#ff1493' }],
    typography: '粗体卡通字体',
  ...
  // ===== 材质纹理 (6) =====
  {
    id: 'paper-texture', slug: 'paper-texture', name: 'Paper Texture', nameZh: '纸张纹理',
    category: 'material', year: '永恒',
    tagline: '纸的纤维。',
    description: '通过模拟纸张的纹理(粗糙/颗粒/折痕/水渍),增加触觉感与真实感,是高端品牌、文创产品、有机品牌的常用手法。',
    characteristics: ['纸纹理底', '折痕/水渍', '颗粒感', '触感强', '温暖'],
    colors: [{ name: '牛皮纸', hex: '#c9a878' }, { name: '宣纸', hex: '#f5e8c7' }, { name: '米色', hex: '#e8dcc0' }],
    typography: '衬线/手写',
  ...
  {
    id: 'frosted-glass', slug: 'frosted-glass', name: 'Frosted Glass', nameZh: '毛玻璃',
    category: 'material', year: '现代',
    tagline: '朦胧的层次。',
    description: '毛玻璃效果通过背景模糊 + 半透明实现,在 UI 中营造层次感与空间感,是 Apple 推动的现代界面语言。',
    characteristics: ['半透明', '背景模糊', '细边框', '层次感', '高级'],
    colors: [{ name: '白半透明', hex: 'rgba(255,255,255,0.2)' }, { name: '彩色背景', hex: '#7c3aed' }],
    typography: '现代无衬线',
  ...
  {
    id: 'metallic', slug: 'metallic', name: 'Metallic', nameZh: '金属质感',
    category: 'material', year: '古典',
    tagline: '金属的反射。',
    description: '金属质感通过渐变 + 高光 + 阴影模拟金/银/铜/铬的反射,营造奢华、未来、科技感,常用于高端品牌和游戏 UI。',
    characteristics: ['金属渐变', '高光', '反射', '奢华', '未来感'],
    colors: [{ name: '金', hex: '#d4af37' }, { name: '银', hex: '#c0c0c0' }, { name: '铬蓝', hex: '#a8c0d0' }],
    typography: '粗衬线/未来感',
  ...
  {
    id: 'wood-grain', slug: 'wood-grain', name: 'Wood Grain', nameZh: '木纹质感',
    category: 'material', year: '永恒',
    tagline: '树的年轮。',
    description: '木纹质感模拟天然木材的纹理与色调,传达自然、温暖、可靠、手作感,常见于家居、咖啡、手工艺品牌。',
    characteristics: ['木纹纹理', '暖色调', '自然感', '手作温度', '可靠'],
    colors: [{ name: '胡桃', hex: '#5c3317' }, { name: '橡木', hex: '#c9a878' }, { name: '松木', hex: '#deb887' }],
    typography: '衬线/手写',
    useCases: ['家居', '咖啡', '手工艺'],
    examples: ['星巴克', '宜家'],
    visual: 'wood',
  ...
  {
    id: 'water-ripple', slug: 'water-ripple', name: 'Water Ripple', nameZh: '水波纹',
    category: 'material', year: '永恒',
    tagline: '水的呼吸。',
    description: '模拟水波/涟漪的动态效果,传达流动、清新、平静的氛围,常见于水品牌、Spa、冥想类应用。',
    characteristics: ['波纹', '蓝色调', '流动感', '清新', '平静'],
    colors: [{ name: '湖蓝', hex: '#4a90a4' }, { name: '浅蓝', hex: '#a4c8e1' }, { name: '白', hex: '#ffffff' }],
    typography: '轻盈无衬线',
  ...
  {
    id: 'fabric', slug: 'fabric', name: 'Fabric Texture', nameZh: '织物质感',
    category: 'material', year: '永恒',
    tagline: '织物的温度。',
    description: '模拟布料/织物纹理(亚麻/棉/丝绸/羊毛),传达温暖、舒适、手作品牌感,常见于服装、家居、手作品牌。',
    characteristics: ['织物纹理', '温暖色调', '柔软感', '手作品牌', '舒适'],
    colors: [{ name: '亚麻', hex: '#e8dcc0' }, { name: '靛蓝', hex: '#1e3a8a' }, { name: '砖红', hex: '#a82d2d' }],
    typography: '衬线/手写',
    useCases: ['服装', '家居', '手作品牌'],
  ...
  // ===== 现代趋势 (10) =====
  {
    id: 'modern-tech', slug: 'modern-tech', name: 'Modern Tech', nameZh: '现代科技',
    category: 'modern', year: '2020s',
    tagline: '深色与光晕。',
    description: '2020 年代科技产品的视觉语言,以深色背景 + 渐变光晕 + 等宽字体 + 几何图形营造专业、前沿、神秘的氛围。',
    characteristics: ['深色背景', '渐变光晕', '等宽字体', '几何装饰', '高科技感'],
    colors: [{ name: '深蓝', hex: '#0a1628' }, { name: '蓝', hex: '#3b82f6' }, { name: '紫', hex: '#8b5cf6' }],
  ...
  {
    id: 'editorial', slug: 'editorial', name: 'Editorial', nameZh: '编辑设计',
    category: 'modern', year: '2010s',
    tagline: '杂志的呼吸。',
    description: '源自杂志编辑设计的网页风格,以大字号衬线 + 强烈对比 + 精致排版 + Bento 网格为标志,常用于品牌故事、个人作品集。',
    characteristics: ['大字号', '衬线体', 'Bento 网格', '强烈对比', '故事感'],
    colors: [{ name: '暖白', hex: '#fafaf7' }, { name: '黑', hex: '#0a0a0a' }, { name: '品牌色', hex: '#c43e3e' }],
    typography: '衬线 + 无衬线混排',
  ...
  {
    id: 'nordic', slug: 'nordic', name: 'Nordic', nameZh: '北欧极简',
    category: 'modern', year: '1950s',
    tagline: '冷与光的呼吸。',
    description: '源自斯堪的纳维亚设计的北欧极简,以白底 + 柔和粉彩 + 大量留白 + 自然光为标志,营造明亮、舒适、生活的氛围。',
    characteristics: ['大量留白', '柔和粉彩', '自然光', '功能性', '生活感'],
    colors: [{ name: '白', hex: '#fafaf7' }, { name: '淡粉', hex: '#f5e6e0' }, { name: '浅灰蓝', hex: '#c8d5e0' }],
  ...
  {
    id: 'dark-first', slug: 'dark-first', name: 'Dark First', nameZh: '暗色优先',
    category: 'modern', year: '2010s',
    tagline: '暗夜为默认。',
    description: '以暗色为默认主题的设计语言,通过减少光刺激、突出色彩对比,营造专业、专注、高级的氛围,是开发者工具和音乐产品的首选。',
    characteristics: ['暗色背景', '高对比', '霓虹/品牌色点缀', '专注感', '专业'],
    colors: [{ name: '深灰', hex: '#0a0a0a' }, { name: '灰', hex: '#1a1a1a' }, { name: '品牌色', hex: '#3b82f6' }],
    typography: '清晰无衬线',
  ...
  {
    id: 'brutalism', slug: 'brutalism', name: 'Brutalism', nameZh: '野兽派',
    category: 'modern', year: '2010s',
    tagline: '原始的诚实。',
    ...
    colors: [{ name: '亮黄', hex: '#ffff00' }, { name: '蓝', hex: '#0000ff' }, { name: '白', hex: '#ffffff' }],
  ...
  {
    id: 'magazine', slug: 'magazine', name: 'Magazine', nameZh: '杂志风',
    category: 'modern', year: '现代',
    tagline: '卷轴的故事。',
    description: '模仿印刷杂志的网页设计,以封面级大图 + 跨页布局 + 多栏排版 + 强烈字号对比为标志,适合长篇阅读和品牌故事。',
    characteristics: ['大图封面', '多栏排版', '强烈字号', '跨页布局', '故事感'],
    colors: [{ name: '黑', hex: '#0a0a0a' }, { name: '白', hex: '#ffffff' }, { name: '品牌色', hex: '#c43e3e' }],
    typography: '衬线 + 无衬线混排',
  ...
  {
    id: 'flat-design', slug: 'flat-design', name: 'Flat Design', nameZh: '扁平化设计',
    category: 'modern', year: '2012',
    tagline: '去除拟物。',
    description: '2012 年微软 Metro 与苹果 iOS 7 推动的扁平化设计,反对拟物化的渐变/阴影,使用纯色 + 简洁图形,塑造现代移动 UI 语言。',
    characteristics: ['纯色填充', '无渐变', '无阴影', '极简图形', '移动优先'],
    colors: [{ name: '亮蓝', hex: '#2196f3' }, { name: '红', hex: '#f44336' }, { name: '绿', hex: '#4caf50' }],
  ...
  {
    id: 'material-design', slug: 'material-design', name: 'Material Design', nameZh: '材料设计',
    category: 'modern', year: '2014',
    tagline: '纸与影的逻辑。',
    ...
    colors: [{ name: 'Material 蓝', hex: '#1976d2' }, { name: 'Material 红', hex: '#d32f2f' }, { name: '灰', hex: '#f5f5f5' }],
    typography: 'Roboto',
  ...
  {
    id: '3d-illustration', slug: '3d-illustration', name: '3D Illustration', nameZh: '3D 插画',
    category: 'modern', year: '2018',
    tagline: '立体的表达。',
    ...
    colors: [{ name: '柔粉', hex: '#ffc1cc' }, { name: '柔蓝', hex: '#a4c8e1' }, { name: '奶白', hex: '#f5f0e8' }],
    typography: '圆润现代无衬线',
  ...
  {
    id: 'gradient-mesh', slug: 'gradient-mesh', name: 'Gradient Mesh', nameZh: '渐变网格',
    category: 'modern', year: '2020',
    tagline: '色彩的地形。',
    description: '渐变网格以多个色彩控制点模拟摄影般的色彩过渡,从 Figma/Apple 推动后成为现代 UI 与品牌设计的主流语言。',
    characteristics: ['多色渐变', '柔和过渡', '现代感', '色彩丰富', '摄影感'],
    colors: [{ name: '紫', hex: '#8b5cf6' }, { name: '粉', hex: '#ec4899' }, { name: '青', hex: '#06b6d4' }, { name: '蓝', hex: '#3b82f6' }],
    typography: '现代无衬线',
...
// 按分类分组
export const STYLES_BY_CATEGORY = CATEGORIES.map(cat => ({
  ...cat,
  styles: STYLES.filter(s => s.category === cat.id),
}))
